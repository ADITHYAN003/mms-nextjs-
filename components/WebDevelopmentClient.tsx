                                ...
                                <div className="grid sm:grid-cols-2 gap-8">
                                    {[
                                        ...
                                        <div
                                            ...
                                            className="content-block p-10 rounded-[3rem] bg-[#faf3e0]/50 border border-[#652b32]/5 hover:bg-[#652b32] hover:text-white transition-all duration-500 group shadow-lg cursor-pointer"
                                        >
                                            <div className="w-14 h-14 rounded-2xl bg-[#652b32]/5 flex items-center justify-center mb-8 group-hover:bg-white/10 transition-colors">
                                                <card.icon className="w-6 h-6 text-[#652b32] group-hover:text-yellow-400 transition-colors" />
                                            </div>
                                            <h3 className="font-heading text-xl font-black mb-4 uppercase tracking-tight leading-tight">{card.title}</h3>
                                            <p className="text-[#652b32]/60 group-hover:text-white/70 text-sm font-medium leading-relaxed">{card.desc}</p>
                                            <div className="mt-6 flex items-center gap-2 text-[#652b32]/40 group-hover:text-yellow-400 font-black uppercase tracking-widest text-[10px] transition-colors">
